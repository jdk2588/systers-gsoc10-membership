...
def sizeof(filename, lang):
    """Returns the size of a file and its prefix"""
    try:
...
#              the thread, for dlists
#  body       : A list of strings making up the message body
#  thread_addr: The address to contribute to the thread, for dlists

class Article(pipermail.Article):
    """Handles the articles in the archives and creating new ones"""
...
class HyperArchive(pipermail.T):
    """Formater for the hyper archive"""
